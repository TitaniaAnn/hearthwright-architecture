...
[OBSERVABILITY-NOTES.md](OBSERVABILITY-NOTES.md) — key concepts from
*Observability Engineering* 2e (O'Reilly), framed for this repo. Consult when
adding instrumentation, telemetry, SLOs, or evaluating observability tooling.
The repo's instrumentation today is the console-first layer in
`src/lib/observability.ts` (ARCHITECTURE.md §13); these notes are forward
reference beyond it.
